...
\title{Instructions for Computer Graphics Project Report Submission}

% TODO: Replace with your team members' names.
\author{
Team Member1$^1$, Team Member2$^2$ \\
$^1$Informatik, $^2$Medieninformatik \\
\texttt{\{member1, member2\}@student.uni-tuebingen.de}
}
