...
\author{
Tarik Eker$^1$, Niklas Munkes$^2$, Kaan Yücel$^1$, Ronny Göttler$^2$ \\
$^1$Informatik \\
$^2$Medieninformatik \\
\texttt{\{tarik.eker, niklas.munkes, kaan.yuecel, ronny.goettler\}@student.uni-tuebingen.de}
}
...
% paragraph.
\end{abstract}
\input{sections/introduction and motivation}
