...
\titlelogo{%
  \includegraphics[width=3.967cm, keepaspectratio=true]{../../util/graphics/UT-logo.pdf}
  \hskip0.4cm 
  %% Trajan
  \begin{minipage}[t]{0.5\textwidth}
  \vskip-0.95cm
  \includegraphics[width=5.75cm, keepaspectratio=true]{../../util/graphics/UT-MNF-FBI-logo.pdf}
  \end{minipage}%
}
...
\headlinelogo{%
  \includegraphics[width=2.52cm, keepaspectratio=true]{../../util/graphics/UT-logo.pdf}
}      
